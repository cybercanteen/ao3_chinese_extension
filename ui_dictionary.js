...
window.AO3_UI_DICT = {
  exact: {
    ...
    "Name (required)": "笔名（必填）",
    "Make this name default": "设为默认笔名",
    "Description": "简介",
    "Embedded images (<img> tags) will be displayed as HTML, including the image's source link and any alt text.": "嵌入的图片（<img> 标签）将以HTML形式显示，并保留图片来源链接及替代文本。",
    "Icon": "头像",
    "You can have one icon for each pseud.": "每个笔名都可以设置一个头像。",
    "Icons can be in png, jpeg or gif form.": "头像可使用PNG、JPEG或GIF格式。",
    "Icons should be sized 100x100 pixels for best results.": "建议使用100 × 100像素的头像，以获得最佳显示效果。",
    "This is your icon.": "这是你的头像。",
    "Upload a new icon": "上传新头像",
    "Icon alt text": "头像内容说明",
    "Icon comment text": "头像备注",
    "Create Pseud": "创建笔名",
    "Back to Pseuds": "返回笔名列表",
    "Default Pseud": "默认笔名",
    "Delete your icon and revert to our default. This will also remove your icon alt text and comment text.": "删除你的头像并恢复为默认头像。此操作也会删除你的头像内容说明和备注。",
    ...
    "About Me": "关于我",
    "Edit Default Pseud and Icon": "编辑默认笔名与头像",
